# Start in small village
# Introduction of what happens
# What to do
# Find letter detailing what Robin did

# Infiltrate human cities to find information about artifacts
# Go to four major terrains, find keys
# Find Pandora’s box
# Protect all

# Details
# Go to each place whenever you want to
# Chapter 1: Time Key
# Chapter 2: Creation and Destruction Keys
# Within Chaos, lies an opportunity
# Chapter 4: Mind Key

# Declare characters used by this game.
define d = Character(_("Detective "), color="#c8ffc8")
